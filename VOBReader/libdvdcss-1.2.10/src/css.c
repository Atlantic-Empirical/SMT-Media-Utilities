...
/*****************************************************************************
 * _drive_unlock: authorize the drive //TRPF ADDED
 *****************************************************************************/
int _drive_unlock( char * DriveLetter )
{
	int i_ret = -1;
	...
	dvdcss->psz_device = (char *)strdup( DriveLetter );
...
{
    print_debug( dvdcss, "%s%02x:%02x:%02x:%02x:%02x", prefix, data[0], data[1], data[2], data[3], data[4] );
}
 ...
 *****************************************************************************/
static int CrackTitleKey( dvdcss_t dvdcss, int i_pos, int i_len, dvd_key_t p_titlekey )
{
